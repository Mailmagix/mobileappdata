...
import FitnessCategoriesArray from './fitnessCategoriesArray';
import SmallDotIcon from 'react-native-vector-icons/MaterialCommunityIcons';

const Fitness = ({onChangeContent}) => {
  const handlePress = action => {
    if (action === 'Stress') {
      onChangeContent('Stress');
    ...
    <View style={styles.container}>
      ...
      <View style={styles.categorySections}>
        ...
        <View style={styles.fitnessContainer}>
          {FitnessCategoriesArray.map((item, index) => (
            <View key={index} style={styles.categoryView}>
              ...
              <View style={styles.duration}>
                <Text style={styles.text}>10 questions</Text>
                <View style={{alignItems: 'center', justifyContent: 'center'}}>
                  <SmallDotIcon name={'circle-small'} size={18} color="black" />
                </View>
